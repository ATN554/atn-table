...
const renderSortAZ = (column, fnc) => {
  if (column.group.locked) {
    if (column.group.order === "asc") {
      return (<SortAZ className={"atn-group-use-az"} style={{ fill: "var(--svg-fill-disabled-active)" }} />);
    } else {
      return (<SortAZ className={"atn-group-use-az"} style={{ fill: "var(--svg-fill-disabled-inactive)" }} />);
    }
  } else {
    if (column.group.order === "asc") {
      return (<SortAZ className={"atn-group-use-az active"} style={{ fill: "var(--svg-fill-enabled-active)" }} />);
    } else {
      return (<SortAZ className={"atn-group-use-az active"} style={{ fill: "var(--svg-fill-enabled-inactive)" }} onClick={() => fnc(column, "asc")} />);
    }
  }
}
...
const renderSortZA = (column, fnc) => {
  if (column.group.locked) {
    if (column.group.order === "desc") {
      return (<SortZA className={"atn-group-use-za"} style={{ fill: "var(--svg-fill-disabled-active)" }} />);
    } else {
      return (<SortZA className={"atn-group-use-za"} style={{ fill: "var(--svg-fill-disabled-inactive)" }} />);
    }
  } else {
    if (column.group.order === "desc") {
      return (<SortZA className={"atn-group-use-za active"} style={{ fill: "var(--svg-fill-enabled-active)" }} />);
    } else {
      return (<SortZA className={"atn-group-use-za active"} style={{ fill: "var(--svg-fill-enabled-inactive)" }} onClick={() => fnc(column, "desc")} />);
    }
  }
}
